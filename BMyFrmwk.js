...
BMy.fn = BMy.prototype = {
	...
	getByTagName: function(nomeTag){
			return document.getElementsByTagName(nomeTag);
			},
	getByTagName: function(nomeId,nomeTag){
			return (this.getById(nomeId)).getElementsByTagName(nomeTag);
			},
